...
public class FirestoreRepository {
    ...
    public DocumentReference getProgressDocument(String uid) throws InterruptedException, ExecutionException {
        return firestore.collection("progress").document(uid);
    }
}
